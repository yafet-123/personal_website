  ...
  return (
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 py-5">
        ...
        <span class="font-poppins font-normal xs:text-[14px] xs:leading-[20px] text-[20px] leading-[16.89px] tracking-[0.5%] text-[#6B707B] mt-1 text-right">{exhibition.type}</span>
      </div>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <Link 
          className="font-poppins font-semibold text-[14px] leading-[16px] text-white rounded-full cursor-pointer bg-[#2190FF] py-3 px-6 w-fit min-h-[48px]"
          href={`/exhibitions/${id}`}
        >
          View Photo
        </Link>
